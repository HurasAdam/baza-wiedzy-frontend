...
interface UserStatisticsAddedArticlesModalProps {
...
export const UserStatisticsAddedArticlesModal = ({
  selectedUser,
                        ...
                        <tr key={article._id} className="border-b border-border hover:bg-muted/30 transition-colors">
                          ...
                          <td className="py-3 px-6 text-right">
                            <div className="flex justify-center gap-3">
                              <a
                                href={`${import.meta.env.VITE_FRONTEND_BASE_URL}/articles/${article._id}`}
                                target="_blank"
