...
import { useArticleToggleFavouriteMutation, useFindArchivizedArticles } from "../../../hooks/articles/use-articles";
...
export const AdminArchivedArticlesPage: React.FC = () => {
  ...
  const {
    ...
    isLoading,
    isError,
  } = useFindArchivizedArticles(searchParams);
