...
import { ArticleEditBanner } from "../../../../articlev2/ArticleEditPage/components/ArticleEditBanner";
import { ArticleEditHeader } from "../../../../articlev2/ArticleEditPage/components/ArticleEditHeader";
import { ArticleEditPageSkeleton } from "../../../../articlev2/ArticleEditPage/components/ArticleEditPageSkeleton";
...
export const ArchivedArticleEditPage = () => {
  ...
  const {
    ...
    refetch,
    isRefetching,
  } = useFindOneArchivizedArticle(articleId!);
