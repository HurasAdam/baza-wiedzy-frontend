      ...
      {items.map((el) => {
        ...
        return (
          <Button
            ...
            className={cn(
              "justify-start text-sidebar-foreground hover:text-sidebar-accent-foreground hover:bg-transparent",
              isActive && "bg-sidebar-primary hover:bg-sidebar-primary text-sidebar-primary-foreground font-medium"
            )}
            onClick={handleClick}
          >
